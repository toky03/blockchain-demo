...
import {Card, CardContent, Grid, IconButton, Link, Slider, Typography} from "@material-ui/core";
        ...
        <div className={'blockList'}>
            ...
            >
                <Card style={conceptDescriptionCardStyle}>
                    ...
                    <Trans i18nKey={'demo.pos.content'} >text<Link href={'https://cardano.org/ouroboros/'}>Link</Link>text</Trans>
